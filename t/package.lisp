...
(test lat-lon-to-utm
  (let ((tolerance 0.002)
        (coords (list #(39.9835310406d0 -105.2536113560d0 "NAD83" 13 478346.59856d0 4425960.12177d0)
    ...
    (dolist (coord coords)
      (let* ((lat (aref coord 0))
        ...
        (declare (type double-float lat lon easting northing teasting tnorthing)
                 (type fixnum tzone zone)
